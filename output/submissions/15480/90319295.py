...
def main():
    ...
    for _ in range(m):
        ...
        if tmp == 1:
            ...
            if query(parent,depth,a,r) == a and query(parent,depth,b,r) == b:
                if depth[a] < depth[b]: print(b)
                else: print(a)
            elif query(parent,depth,a,r) == a: print(a)
            elif query(parent,depth,b,r) == b: print(b)
            else: print(lca)
