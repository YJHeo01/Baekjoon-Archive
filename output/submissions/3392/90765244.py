...
for _ in range(n):
    ...
    update_max_s(max_high,max_lazy,1,x1+1,x2-1,0,30000,y2)
    update_min_s(min_high,min_lazy,1,x1+1,x2-1,0,30000,y1)
...
for i in range(30000):
    l,r = i, i + 1
    max_value = max_query(max_high,max_lazy,1,l,r,0,30000)
    min_value = min_query(min_high,min_lazy,1,l,r,0,30000)
