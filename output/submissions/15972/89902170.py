    ...
    while q:
        ...
        for dx,dy in [(0,1),(0,-1),(1,0),(-1,0)]:
            ...
            if water[nx][ny] > next_high:
                ...
                heapq.heappush(q,(next_high,next_high-hole_high,nx,ny))
    #print_water(water)            
