...
def main():
    ...
    for _ in range(m):
        ...
        if tmp == 1:
            ...
            a_r_lca = query(parent,depth,a,r)
            b_r_lca = query(parent,depth,b,r)
            a_b_lca = query(parent,depth,a,b)
            answer = a_b_lca
            if depth[b_r_lca] > depth[answer]: answer = b_r_lca
            if depth[a_r_lca] > depth[answer]: answer = a_r_lca
            print(answer)
